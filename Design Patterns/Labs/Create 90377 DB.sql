USE [master]
GO
/****** Object:  Database [90377]    Script Date: 24/10/2020 22.50.00 ******/
CREATE DATABASE [90377]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'90377', FILENAME = N'C:\Users\JesperGulmannHenriks\90377.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'90377_log', FILENAME = N'C:\Users\JesperGulmannHenriks\90377_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [90377] SET COMPATIBILITY_LEVEL = 130
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [90377].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [90377] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [90377] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [90377] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [90377] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [90377] SET ARITHABORT OFF 
GO
ALTER DATABASE [90377] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [90377] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [90377] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [90377] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [90377] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [90377] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [90377] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [90377] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [90377] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [90377] SET  DISABLE_BROKER 
GO
ALTER DATABASE [90377] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [90377] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [90377] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [90377] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [90377] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [90377] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [90377] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [90377] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [90377] SET  MULTI_USER 
GO
ALTER DATABASE [90377] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [90377] SET DB_CHAINING OFF 
GO
ALTER DATABASE [90377] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [90377] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [90377] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [90377] SET QUERY_STORE = OFF
GO
USE [90377]
GO
...
USE [master]
GO
ALTER DATABASE [90377] SET  READ_WRITE 
GO
